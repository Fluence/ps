  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const transactions = await fetch('https://wavesplaygroud.com/puzzleswap-txs').then(r => r.json());
        const liquidityAddings = await fetch('https://wavesplaygroud.com/puzzleswap-lp').then(r => r.json());
