  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const transactions = await fetch('https://puzzlepedia.cc/data/puzzleswap-txs').then(r => r.json());
        const liquidityAddings = await fetch('https://puzzlepedia.cc/data/puzzleswap-lp').then(r => r.json());
