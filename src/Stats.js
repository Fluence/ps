...
export function Stats( {tradesInLastTwentyFourHours} ) {
  ...
  useEffect(() => {
    async function getTokenData() {
      try {
        const fetchedTradingNumbers = await fetch('https://data.puzzlepedia.com/puzzleswap-trades');
        ...
        const fetchedVolumeNumbers = await fetch('https://data.puzzlepedia.com/puzzleswap-volumes');
