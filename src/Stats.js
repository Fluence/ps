...
export function Stats( {tradesInLastTwentyFourHours} ) {
  ...
  useEffect(() => {
    async function getTokenData() {
      try {
        const fetchedTradingNumbers = await fetch('https://github.com/Fluence/ps/blob/feeabae18e84fd9ab32227b2a5de7ef5203e8453/src/data/puzzleswap-trades');
        ...
        const fetchedVolumeNumbers = await fetch('https://github.com/Fluence/ps/blob/feeabae18e84fd9ab32227b2a5de7ef5203e8453/src/data/puzzleswap-volumes');
